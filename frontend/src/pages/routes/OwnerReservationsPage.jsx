      ...
      <div className="list">
        {ownerReservations.map((reservation) => (
          <article key={reservation.id} className="list-item">
            ...
            <p>
              Gost: {reservation.guest?.firstName} {reservation.guest?.lastName}
            </p>
            <p>
              Boravak: {formatDate(reservation.checkIn)} -{" "}
              {formatDate(reservation.checkOut)}
            </p>
            <p>
              Trajanje:{" "}
              {getStayNights(reservation.checkIn, reservation.checkOut)} noći
            </p>
            <div className="row gap">
              <Link
                to={`/app/owner/reservations/${reservation.id}`}
